...
from info.models import (
    Region, PromotionalCodesAndDiscount, Banner, FAQ, AboutApp, Support, Ad, VersionControl
)
...
class RegionSerializer(ModelSerializer):
    ...
    class Meta:
        model = Region
        fields = ('pk', 'title', 'sub_title')


class PromotionalCodesAndDiscountSerializer(ModelSerializer):
