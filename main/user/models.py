...
from user.utils import generate_verification_code
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def is_business(self):
        if hasattr(self, 'business'):
            return self.business.is_active
        return False

    @property
    def is_tariff_selected(self):
        if hasattr(self, 'business'):
            return self.business.is_tariff_selected
        return False

    @property
    def is_car_brands_selected(self):
        if hasattr(self, 'business'):
            return self.business.is_car_brands_selected
        return False
