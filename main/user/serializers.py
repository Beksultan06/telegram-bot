...
from user.mixins import PhoneNumberValidateMixin
from user.otp import send_nikita_sms
...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = (
            'pk', 'name', 'profile_photo', 'phone_number', 'is_business',
            'business', 'fcm_token', 'has_new_notifications', 'is_tariff_selected', 'is_car_brands_selected'

        )
        read_only_fields = (
            'phone_number', 'is_business', 'business',
            'has_new_notifications', 'is_tariff_selected', 'is_car_brands_selected'
        )


class UserDetailForPurchaseRequestSerializer(UserDetailSerializer):
    class Meta:
        model = User
        fields = ('pk', 'name', 'profile_photo', 'phone_number',)
